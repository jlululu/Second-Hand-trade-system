...
<% using (Html.BeginForm("Create2", "EF", FormMethod.Post, new { enctype ="multipart/form-data"})) { %>
    ...
    <fieldset>
        ...
        <div class="editor-field">
            <%:Html.HiddenFor(model => model.Status, new {@Value="求"})%>
      ...
      <!--  <div class="editor-field">
       ...
       <select id="type" name="Type" style="width: 145px; height: 26px">
        ...
        <div class="editor-field">
            <%: Html.HiddenFor(model => model.Pic,new {@Value="/Images/PicScarf.jpg" })%>
